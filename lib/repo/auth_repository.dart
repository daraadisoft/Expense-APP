...
class AuthRepository {
  ...
  Future<DataState<String>> requestVerifyAccount(
    ...
    try {
      var response = await HttpService.httpService.post(url: AppUrl.requestVerifyAccount, body: {'email': email});
      return DataState(
  ...
  Future<DataState<bool>> registerAccount({required RegisterModel registerModel})async{


    try{

      var response = await HttpService.httpService.post(url: AppUrl.registerURL,body: registerModel.toJson());
